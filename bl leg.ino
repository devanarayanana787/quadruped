...
const int fr_servoPins[3] = {13, 11, 12}; // {coxa, femur, tibia}
Servo fr_servos[3];
...
const long POSE_HOLD_TIME = 3000; // Hold each pose for 3 seconds
...
LegAngles convertToServoAngles(LegAngles kinematicAngles) {
  ...
  servoAngles.coxa = 90.0 + (180-abs(kinematicAngles.coxa)) ;
